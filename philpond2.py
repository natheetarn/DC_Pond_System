...
MULTICAST_PORT = 5008
INTERVAL = 2
STATE_FILE = "pond2_state.json"
LOG_FILE = "pond2_log.txt"
...
def set_up(state):
    print("SETTING UP AS SECOND POND")
    logging.info("SETTING UP AS SECOND POND")
...
def send_multicast():
    ...
    while True:
        ...
        message = f"Current time2: {current_time}"
...
if __name__ == "__main__":
    setup_logging()
    state = load_state() or {"is_set_up": False}
